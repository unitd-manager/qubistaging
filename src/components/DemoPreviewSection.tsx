...
const DemoPreviewSection = () => {
  ...
  const videoTitle = videoSection?.attributes.section_title ?? bootstrappedDemo?.videoTitle ?? "qubi Platform Full Demo";
  const videoDuration =
    videoSection?.attributes.description ?? bootstrappedDemo?.videoDuration ?? "12 minutes End-to-end execution walkthrough";
