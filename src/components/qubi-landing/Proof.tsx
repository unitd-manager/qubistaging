        ...
        <div className="story-grid reveal">
          <article className="story-main">
            ...
            <div className="story-foot">
              ...
              <a className="btn btn-light" href="https://myqubi.com/customers" target="_blank" rel="noreferrer">Read the story →</a>
            </div>
          </article>
          <div className="story-side">
            <article className="story-card">
              ...
              <a href="https://myqubi.com/customers" target="_blank" rel="noreferrer">View customer story →</a>
            </article>
            <article className="story-card">
              <div>
