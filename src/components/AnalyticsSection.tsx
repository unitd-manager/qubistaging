...
const AnalyticsSection = () => {
  ...
  const eyebrow = data?.section?.attributes?.template ?? "Analytics & Trust";
  const heading = data?.section?.attributes?.section_title ?? "Visibility, performance, and accountability built in";
