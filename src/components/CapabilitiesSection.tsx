...
const CapabilitiesSection = () => {
  ...
  const eyebrow = data?.section?.attributes?.template ?? "What qubi is";
  const heading = data?.section?.attributes?.section_title ?? "One platform. Modular capabilities. Enterprise control.";
